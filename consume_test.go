		...
		Items: []*RssItem{
			{
				...
				Category:     "",
				Comments:     "",
				MediaContent: &RssMediaContent{Url: "localhost/image/img.png", Length: "123", Type: "image/png"},
				Guid:         &Id{IsPermaLink: true, Guid: "http://jmoiron.net/blog/limiting-concurrency-in-go/"},
				PubDate:      "Tue, 30 Oct 2018 23:22:00 GMT",
				Source:       "",
			},
			{
...
func TestRssUnmarshal(t *testing.T) {
	...
	err = xml.Unmarshal(bytes, &xmlFeed)
	if err != nil {
		t.Log(err)
		return
	}
